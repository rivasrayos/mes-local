...
async function ensureSchema() {
  ...
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_line_number ON inspections (line_number)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_pass_fail ON inspections (pass_fail)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_sn ON inspections (sn)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_carrier_sn ON inspections (carrier_sn)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_inspection_time ON inspections (inspection_time)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_created_at ON inspections (created_at)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_inspections_station_name ON inspections (station_name)`);
  await query(`CREATE INDEX IF NOT EXISTS idx_batches_received_at ON inspection_batches (received_at)`);
